...
public class HttpRequestService {
     ...
     * @return
     */
    public ContentResponse sendHttpRequest(String jsonPayload, String url, HttpMethod requestType) {
    ...
    private String getAccessToken() {
        ...
        } else if (System.nanoTime() > TimeUnit.NANOSECONDS.convert(keycloakAccessToken.getExpiresIn(), TimeUnit.SECONDS) + keycloakAccessToken.getAcquireTime()) {
