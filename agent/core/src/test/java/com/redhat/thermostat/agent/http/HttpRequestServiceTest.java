...
public class HttpRequestServiceTest {
    ...
    @Test
    public void testRequestWithoutKeycloak() throws InterruptedException, ExecutionException, TimeoutException {
    ...
    @Test
    public void testRequestWithKeycloak() throws InterruptedException, ExecutionException, TimeoutException {
        AgentStartupConfiguration configuration = mock(AgentStartupConfiguration.class);
    ...
    @Test
    public void testRequestWithKeycloakRefresh() throws InterruptedException, ExecutionException, TimeoutException {
        AgentStartupConfiguration configuration = mock(AgentStartupConfiguration.class);
        setupKeycloakConfig(configuration);
    ...
    @Test
    public void testRequestWithNullPayload() throws InterruptedException, ExecutionException, TimeoutException {
        AgentStartupConfiguration configuration = mock(AgentStartupConfiguration.class);
        when(configuration.isKeycloakEnabled()).thenReturn(false);
