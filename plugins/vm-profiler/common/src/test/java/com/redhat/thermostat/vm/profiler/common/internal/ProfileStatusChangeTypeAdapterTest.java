...
public class ProfileStatusChangeTypeAdapterTest {
    ...
    public void testWrite() {
        ...
        builder.registerTypeAdapter(ProfileStatusChange.class, new ProfileStatusChangeTypeAdapter());
        Gson gson = builder.create();
        ProfileStatusChange change = new ProfileStatusChange();
        change.setTimeStamp(100l);
        change.setVmId("1");
        change.setAgentId("2");
