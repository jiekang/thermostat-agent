...
public class JmxNotificationTypeAdapterTest {
    ...
    public void testJmxNotificationGetsSerializedCorrectly() {
        ...
        builder.registerTypeAdapter(JmxNotification.class, new JmxNotificationTypeAdapter());
        Gson gson = builder.create();
        JmxNotification notification = new JmxNotification();
        notification.setTimeStamp(123456789l);
        notification.setContents("This is a notification");
        notification.setSourceBackend("Non existent Backend");
