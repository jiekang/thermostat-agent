...
public class VmClassStatTypeAdapterTest {
    ...
    public void testRead() {
        ...
        builder.registerTypeAdapter(VmClassStat.class, new VmClassStatTypeAdapter());
        Gson gson = builder.create();
        VmClassStat stat = new VmClassStat();
        stat.setVmId("1");
        stat.setAgentId("2");
        stat.setTimeStamp(100l);
        stat.setClassLoadTime(2000l);
        stat.setLoadedBytes(10l);
